...
# path = "/FileStore/shared_uploads/lena.deroeck@student.uantwerpen.be/web_Google.txt"

am_nodes = 875713
am_edges = 5105039

edges = sc.textFile(inputfile)
